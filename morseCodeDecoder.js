...
(that was first issued by Titanic), that is coded as ···−−−···. These special 
...
// write a converter for morsecode to letters with a hash
var converter = {
  '.-': 'A',
  '-...': 'B',
  '-.-.': 'C',
...
var decodeMorse = function(morseCode){
  ...
  for(var i = 0; i < morseCode.length; i++) {
    // swap each morse code element with its letter using the converter
    if(converter[morseCode[i]]) {
    morseCode[i] = converter[morseCode[i]];
    }
  }
