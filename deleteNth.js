...
He tells them that he will only sit during the session if they show the same motive at most N times. Luckily, 
...
var deleteNth = function(lst, n) {
  var newLst = [];
  var numCounter = {};
  list.forEach(function(v, i, a) {
    numCounter[v] = numCounter[v] || 0;
    numCounter[v]++;
    if(numCounter[v] <= n) {
      newLst.push(v);
    }
